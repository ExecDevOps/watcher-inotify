# About watcher-inotify

watcher-inotify is a daemon that watches specified files/folders for changes and
...
See the provided `config.ini` file for an example job configuration. The
config file should reside in `/etc/config.ini` or `~/.config.ini`. You
